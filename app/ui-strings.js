...
export const strings = {
  sk: {
    ...
    landing: {
      ...
      /*
       * Ukazky na stranke. Texty aj ulohy k nim sa beru zo sablon v
       * lib/settings.js, aby na uvodnej stranke stalo presne to, co dostane
       * organizator po zalozeni akcie. Tu je len nazov akcie.
       */
      examples: [
        { key: 'wedding', names: 'Lucia a Adam' },
        { key: 'company', names: 'Vianočný večierok' },
        { key: 'teambuilding', names: 'Teambuilding 2026' },
      ],
    ...
    admin: {
      ...
      newEvent: 'Nová akcia',
      typeLabel: 'Typ akcie',
      typeHint: 'Podľa neho dostanete vzhľad, texty aj úlohy foto misie. Zmeniť sa dá kedykoľvek.',
    ...
    editor: {
      ...
      font: 'Písmo',
      templateGroup: 'Typ akcie',
      templateHint:
        'Nastaví vzhľad, texty aj úlohy naraz. Potom si všetko môžete prepísať po svojom.',
      templateConfirm: 'Prepíše to vzhľad, texty aj úlohy foto misie. Pokračovať?',

      symbol: 'Znak v hlavičke',
      symbol_ornaments: 'Ozdoby',
      symbol_emoji: 'Emoji',
      symbol_monogram: 'Monogram',
      symbol_logo: 'Logo',
      symbol_none: 'Žiadny',
      symbolHintOrnaments: 'Kreslené vetvičky v rohoch stránky.',
      symbolHintEmoji: 'Jeden znak nad menami.',
      symbolHintMonogram: 'Začiatočné písmená z mien, písané písmom témy.',
      symbolHintLogo: 'Vlastné logo alebo obrázok nad menami.',
      symbolHintNone: 'Stránka ostane čistá, len text.',
      emojiPick: 'Vyberte alebo napíšte vlastné',
      emojiOwn: 'Vlastné emoji',
      monogramHint: 'Z mien vyjde:',

      logo: 'Logo akcie',
      logoHint: 'PNG, JPG alebo WebP do 2 MB. Uloží sa do podpriečinka vo vašom Drive.',
      logoPick: 'Nahrať logo',
      logoReplace: 'Nahrať iné',
      logoRemove: 'Odstrániť',
      logoUploading: 'Nahrávam…',
      logoBadType: 'Podporujeme PNG, JPG a WebP.',
      logoTooBig: 'Súbor má viac než 2 MB.',
      logoFailed: 'Logo sa nepodarilo nahrať.',

      missionsGroup: 'Úlohy foto misie',
      missionPacks: 'Načítať hotové úlohy',
      missionPacksHint: 'Prepíše zoznam úloh, ostatné texty ostanú.',
  ...
  en: {
    ...
    landing: {
      ...
      examples: [
        { key: 'wedding', names: 'Lucy & Adam' },
        { key: 'company', names: 'Christmas Party' },
        { key: 'teambuilding', names: 'Teambuilding 2026' },
      ],
    ...
    admin: {
      ...
      typeHint: 'It sets the look, the texts and the mission tasks. You can change it any time.',
    ...
    editor: {
      ...
      font: 'Type',
      templateGroup: 'Type of event',
      templateHint: 'Sets the look, the texts and the tasks at once. You can rewrite it all after.',
      templateConfirm: 'This replaces the look, the texts and the photo mission tasks. Continue?',

      symbol: 'Mark in the header',
      symbol_ornaments: 'Ornaments',
      symbol_emoji: 'Emoji',
      symbol_monogram: 'Monogram',
      symbol_logo: 'Logo',
      symbol_none: 'None',
      symbolHintOrnaments: 'Drawn sprigs in the page corners.',
      symbolHintEmoji: 'A single mark above the names.',
      symbolHintMonogram: 'Initials from the names, in the theme script.',
      symbolHintLogo: 'Your own logo or image above the names.',
      symbolHintNone: 'A plain page, text only.',
      emojiPick: 'Pick one or type your own',
      emojiOwn: 'Your own emoji',
      monogramHint: 'From the names:',

      logo: 'Event logo',
      logoHint: 'PNG, JPG or WebP up to 2 MB. Stored in a subfolder in your own Drive.',
      logoPick: 'Upload a logo',
      logoReplace: 'Upload another',
      logoRemove: 'Remove',
      logoUploading: 'Uploading…',
      logoBadType: 'PNG, JPG and WebP only.',
      logoTooBig: 'The file is over 2 MB.',
      logoFailed: 'The logo could not be uploaded.',

      missionsGroup: 'Photo mission tasks',
      missionPacks: 'Load ready-made tasks',
      missionPacksHint: 'Replaces the task list, the other texts stay.',
